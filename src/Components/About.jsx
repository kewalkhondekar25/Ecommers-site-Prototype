      ...
      <main>
        <div>
          ...
          <p>We at HealthyMe! delivered bright and early each weekday; guaranteed to be on your doorstep by 11 a.m.
            ...
            Together with exercise, eating a healthy diet in the right proportions can also help you lose weight,
            lower your cholesterol levels and blood pressure and transform into healthy lifestyle you desired.</p>
        </div>
      </main>
    </section>
  )
